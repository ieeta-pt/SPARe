...
def get_coo_sparse_GB(shape, density, dtype=TYPE.float32):
    bytes_per_value = get_bytes_in_dtype(dtype)
...
def get_csr_or_csc_sparse_GB(shape, density, dtype=TYPE.float32):
    bytes_per_value = get_bytes_in_dtype(dtype)
...
def get_csr_sparse_GB(shape, density, dtype=TYPE.float32, indices_dtype=TYPE.int32):
    bytes_per_value = get_bytes_in_dtype(dtype)
...
def get_csc_sparse_GB(shape, density, dtype=TYPE.float32, indices_dtype=TYPE.int32):
    bytes_per_value = get_bytes_in_dtype(dtype)
