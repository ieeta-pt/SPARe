...
def main(dataset_folder):
    ...
    if os.path.exists(os.path.join(dataset_path, "pisa_index")):
        print(f"Skip {dataset_path}, pisa index already exists")
        return 0
    ...
    index_path = os.path.join("./",dataset_path, "pisa_index")
    ...
    iter_indexer = PisaIndex(index_path)
